    ...
    <div className="min-h-screen flex">
        ...
        <div className="">
          {history.length == 0 ? (
            ...
            <div className="">
              ...
              <div className="my-2">
                <button  onClick={handleClearHistory} className="text-red-700">clear history</button>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="flex-1  bg-gradient-to-r from-pink-200 via-red-200 to-pink-200">
        <div className="p-6  bg-white shadow-2xl rounded-2xl text-center mb-6">
          ...
          />
          <button className="bg-pink-500 text-white hover:bg-pink-600 px-6 py-3 rounded-2xl text-lg shadow-md" type="submit">
            Search
          </button>
          </form>
        </div>
