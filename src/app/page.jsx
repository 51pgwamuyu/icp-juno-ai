  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-pink-200 via-red-200 to-pink-100">
      <div className="text-center px-4">
        <h1 className="text-5xl font-bold text-pink-600 mb-4">Welcome to Dr Love AI</h1>
        ...
        <p className="text-md text-gray-600 mb-8">
          Whether you're searching for knowledge, collaboration, or a helping hand, Dr Love AI brings together individuals from all walks of life to create a supportive and dynamic community.
        </p>
        <p className="text-md text-gray-600 mb-8">
